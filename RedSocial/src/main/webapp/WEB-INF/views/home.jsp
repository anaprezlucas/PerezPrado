...
<body >
    ...
    <div class="container">
        ...
        <p style="font-size: 20px; color:white;">Inicia sesi�n para entrar o si a�n no tienes cuenta...reg�strate!</p>
      	<form action="register" method="get">
            	<button class="btn btn-success" style="font-size: 20px; color:white;" type="submit" value="Registrarse" name = "register">Reg�strate</button>
        </form>
        <!--  Aqui añadir un form -->
 ...
 <div class="card card-container">
            ...
            <div>
             ...
             <form action="forgotPassword" method="get">
            	<button style="align-content: center;margin: auto;display: table;" class="btn btn-warning" type="submit" value="forgotPassword" name = "forgotPassword">�Olvid� la Contrase�a?</button>
        	</form>
